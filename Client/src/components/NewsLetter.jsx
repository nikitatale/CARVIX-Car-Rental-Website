...
const NewsLetter = () => {
  return (
   ...
   className="flex flex-col items-center justify-center text-center space-y-2 max-md:px-4 my-10 mb-40">
            ...
            className="md:text-4xl text-2xl font-semibold">Subscribe & Drive Smarter</motion.h1>
            ...
            className="md:text-lg text-gray-500/70 pb-8">
                ...
                Get exclusive deals, travel tips, and the latest car rental offers delivered straight to your inbox.

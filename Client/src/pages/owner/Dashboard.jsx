...
const Dashboard = () => {
  ...
  const {axios, isOwner, currency} = useAppContext();
    ...
    const dashboardCards = [
        ...
        {title: "Total Pendings", value:data.pendingBookings, icon: assets.cautionIconColored},
        {title: "Total Confirms", value:data.completeBookings, icon: assets.listIconColored},
    ]
